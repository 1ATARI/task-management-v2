    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form action="{{route('users.update' , $user->id)}}" method="post" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                ...
                                <select class="form-control" name="role">
                                    ...
                                    <option value="{{$rol->name}}" {{$role->id ==$rol->id ? 'selected':'' }}>{{$rol->display_name}}</option>
>
                                    @endforeach
